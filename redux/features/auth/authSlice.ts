...
export const relogedConnectedUser = createAsyncThunk('auth/relodConnectedUser', async (data, thunkAPI) => {
  try {
 ...
 */
export const fetchConnectedUser = createAsyncThunk('auth/getConnectedUser', async (data, thunkAPI) => {
  try {
    ...
    if (response.data.employeeId) {
      await thunkAPI.dispatch(fetchLinkedEmployee({ employeeId: response.data.employeeId }));
    }
 ...
 */
export const fetchLinkedEmployee = createAsyncThunk('auth/getLinkedEmployee', async (data: { employeeId: string }, thunkAPI) => {
  try {
