...
const JournalEntryTableToolbar = () => {
	const { loading } = useAppSelector((state) => state.journalEntry)
			...
			>
				...
				>
					<Typography variant="h6" id="tableTitle" component="div">
						Liste des Journals de Saisies : SALAIRES
					</Typography>
				</Stack>
			</Toolbar>
...
export default JournalEntryTableToolbar;
