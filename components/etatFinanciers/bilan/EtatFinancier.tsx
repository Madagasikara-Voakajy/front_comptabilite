    ...
    <Document>
      <Page size="A4" orientation="landscape" wrap style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={[styles.row, styles.bold, styles.header]}>
                ...
                <View style={[styles.row_50]}>
                  <View style={styles.col}>
                    <View style={[styles.row, styles.b]}>
                      <Text style={[styles.row_75, styles.t_center]}>Solde 2022 (N)</Text>
                      <Text style={[styles.row_25, styles.b_left, styles.t_center]}>Solde 2021 (N-1)</Text>
                    </View>
                    <View style={[styles.row, styles.b]}>
                      <Text style={[styles.row_25]}>Brut</Text>
                      <Text style={[styles.row_25, styles.b_left]}> Amort / prov</Text>
            ...
            <View style={styles.row_40}>
              <View style={[styles.row]}>
                <View style={[styles.row_50]}>
                  <Text style={styles.t_center}>CAPITAUX PROPRES ET PASSIFS</Text>
                </View>
                <View style={styles.row_50}>
                  <View style={styles.row}>
                    <View style={styles.row_50}>
        ...
        <View style={[styles.row, styles.b]}>
          <View style={[styles.row_60, styles.font_10, styles.p_left]}>
            {dataACTIF.map(({ col1, col2, col3, col4, col5 }, index: any) => {
              return (
                <Fragment key={index}>
                  <OneRowDetailBilanActif col1={col1} col2={col2} col3={col3} col4={col4} col5={col5} />
                </Fragment>
              );
            })}
          </View>
          <View style={[styles.row_40, styles.font_10, styles.p_left]}>
            {dataPASSIF.map(({ col1, col2, col3 }, index: any) => {
              return (
                <Fragment key={index}>
                  <OneRowDetailBilanPassif col1={col1} col2={col2} col3={col3} />
                </Fragment>
              );
            })}
          </View>
        ...
        <View style={[styles.row, styles.b]}>
          ...
          <View style={[styles.row_40]}>
            <OneRowDetailBilanPassif col1="TOTAL" col2="TOTAL_2" col3="TOTAL_3" isTitle={true} />
          </View>
        </View>
        ...
        <View style={[styles.row, styles.b]}>
          ...
          <View style={[styles.row_40]}>
            <OneRowDetailBilanPassif col1="PASSIFS NON-COURANTS" isTitle={true} />
          </View>
        </View>
      ...
      <Stack>
        <SectionNavigation direction="row" justifyContent="space-between" mb={1}>
          <Stack direction={'row'} spacing={4}>
            ...
            <PDFDownloadLink document={FicheBilanPrint} fileName={'Bilan' + new Date().toLocaleString() + '.pdf'}>
              <Button color="info" variant="text" startIcon={<FileDownloadIcon />}>
                Pdf
              </Button>
            </PDFDownloadLink>
