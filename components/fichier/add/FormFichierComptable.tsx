...
import useFetchPcgGlobal from "../../pcg/organism/hooks/useFetchPcgGlobal";
...
const FormFichierComptable = () => {
	...
	const fetchPcgGlobal = useFetchPcgGlobal();
		...
		<Container maxWidth="xl">
			<Formik
				...
				initialValues={
					isEditing
						...
						: {
								...
								PCGId: isEditing ? comptaFile?.PCGId : "",
						  }
				}
				validationSchema={Yup.object({
					...
					PCGId: Yup.string().required("Champ obligatoire"),
				})}
				...
				{(formikProps) => {
                  ...
                  Formulaire fichier comptable{" "} */}
							...
							<FormContainer spacing={2}>
								...
								<CustomStack direction={"row"} spacing={2}>
									<OSSelectField
										id="pcg-global-outlined-basic"
										label="Séléctionnez pcg à utiliser"
										name="PCGId"
										options={pcgList}
										dataKey="name"
										valueKey="id"
